...
sleep 1
echo ""
echo  $white"[#]> KiLLeR Cyber Team Was 
Here ... "
read enter
exit
}
=================================================
echo $yellow
figlet -f smshadow "TOOLS Tuan Swam"
echo $indigo
date
echo $purple")"__________________________________________________           
___________________________"


echo 
$cyan" ["$red"+"$cyan"]
< root@Tuan_Swam:~# Recode ea bangsad!!:v >
   ./Tuan_Swam Gans Banget
 ---------------------------
   \         ,        ,
    \       /(        )`
     \      \ \___   / |
...
echo $cyan" ["$red"+"$cyan"]Thanks To: MR.CL4Y Si Boedjank Ngentod"
echo $cyan" ["$red"+"$cyan"]Team        : KiLLeR Cyber Team		"
echo $cyan" ["$red"+"$cyan"]Github	: https://github.com/Tuan_Swam"
echo $cyan" ["$red"+"$cyan"]Mau Join My Team?"
echo $cyan" ["$red"+"$cyan"]Bisa Whatshap Gw: 083867184119 "
echo $cyan" ["$red"+"$cyan"]Facebook : Tuan Swam"
...
echo $yellow" 51) FCTSPAMMER"
echo $yellow" 52) tools kenangan"
echo $yellow" 53) MrErrorV1"
echo $yellow" 54) Fake Deface"
echo $yellow" 55) biodata Tuan Swam"
echo $yellow" 0) Exit "
echo $white""
...
sleep 1
echo  $white " TERTIPU KAMU BANGSAT BELI LAH MAU NYA GRATISAN!!!:V "
...
sleep 1
echo  $white" KERJA LAH KUWONTOL MAU NYA GRATISAN AJA!!:V "
echo  $red" T E R T I P U "
exit
fi
...
then
clear
echo $red"installing FCTspammer"
sleep 1
...
then
clear
echo $red"installing Tools Kenangan"
sleep 1
git clone https://github.com/MrErroer/ToolsKenangan
cd ~/ToolsKenangan
echo -e $red"T E R I N S T A L " 
exit
fi
...
then
clear
echo " Thanks To KiLLeR Cyber Team"
sleep 1
echo " GW GANS TQ "
sleep 1
echo " root@Tuan_Swam "
